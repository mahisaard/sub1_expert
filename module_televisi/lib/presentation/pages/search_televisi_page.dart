...
class SearchTelevisiPage extends StatelessWidget {
  static const ROUTE_NAME = '/search-televisi';

  const SearchTelevisiPage({super.key});
        ...
        child: Column(
          ...
          children: [
            TextField(
              onChanged: (query) {
                context
                    .read<SearchTelevisiBloc>()
                    .add(OnQueryChangedTelevisi(query));
              },
            ...
            BlocBuilder<SearchTelevisiBloc, TelevisiState>(
              builder: (context, state) {
                if (state is TelevisiLoading) {
                  return const Center(
                    child: CircularProgressIndicator(),
                  );
                } else if (state is TelevisiSearchHasData) {
